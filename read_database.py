...
__author__    = "Paolo Scaccia and Alessandra Valletti"
__copyright__ = "Copyright 2023, AdaptiveMeteo S.r.l."
__credits__   = ["Paolo Scaccia", "Alessandra Valletti"]
__license__   = "--"
__version__ = "1.0"
__maintainer__ = "Paolo Scaccia"
__email__ = ["paolo.scaccia@adaptivemeteo.com", "alessandra.valletti@adaptivemeteo.com"]
...
def read_database(args):
    ...
    if '19700101' in ncfile_header and '21000101' in ncfile_header:
           ncfile_header = f'_{domain}_ALL.nc'
